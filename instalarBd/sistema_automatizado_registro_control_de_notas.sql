...
INSERT INTO `economia` (`id_economia`, `estado_econ`) VALUES
(1, 'alto'),
(2, 'bueno'),
(3, 'intermedio'),
(4, 'bajo');
...
CREATE TABLE IF NOT EXISTS `profesor` (
  ...
  `sx_profe` varchar(1) NOT NULL,
  `tlf_profe` varchar(12) NOT NULL,
  `correo_profe` varchar(20) NOT NULL,
...
--
-- Estructura de tabla para la tabla `secciones_activas`
--
