...
<body>
    ...
    <div class="linea_6">
        <p>
            ...
            natural de <b class="linea_bottom"><?= $estudiante['ciudad'] ?></b><b class="linea_bottom"><?= " – " . $estudiante['estado'] ?></b> de <b class="linea_bottom">11</b> años de edad, ha sido aceptado (a)
            para cursar el <b class="linea_bottom"><?= $grado?></b> grado del Nivel de Educación Primaria, en esta institución, durante el periodo  escolar <b class="linea_bottom">periodo</b>.
