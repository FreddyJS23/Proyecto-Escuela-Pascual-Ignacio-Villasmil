    ...
    <body>
        ...
        <div class="container contenedor_estadisticas1">
            ...
            <div class="row">
                ...
                <div class="col-2"><p class="rounded-circle contenedor_numero"><?php echo $total_estu ?></p></div>
            </div>
        </div>
        ...
        <div class="container contenedor_estadisticas2">
            ...
            <div class="row">
                ...
                <div class="col-2"><p class="rounded-circle contenedor_numero"><?php echo $total_profe  ?></p></div>
            </div>
        </div>
