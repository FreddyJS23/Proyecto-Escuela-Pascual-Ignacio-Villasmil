        ...
        <div class="contenedor_representante contenedor_representante_grid">
            ...
            <div class="campos_representante campos_representante_grid">
                <div class="container_campos container_ci_repre">
                    <input class="input" required type="text" name="ci_repre" id="ci_repre" value="<?= $ci_repre ?>" placeholder=" " autocomplete="off" maxlength="8">
                    <label class="label" id="label_ci_repre" for="ci_repre">Cedula </label>
                </div>
                <div class="container_campos">
                    <input class="input" required type="text" name="nombre_repre" id="nombre_repre" placeholder=" " autocomplete="off" maxlength="30">
                    <label class="label" id="label_nombre_repre" for="nombre_repre">Nombre completo </label>
                </div>
                <div class="container_campos">
                    <input class="input" required type="text" name="apellido_repre" id="apellido_repre" placeholder=" " autocomplete="off" maxlength="30">
                    <label class="label" id="label_apellido_repre" for="apellido_repre">Apellido completo </label>
                </div>
                <div class="container_campos">
                    <input class="input" required type="date" name="fn_repre" id="fn_repre">
                ...
                <div class="container_campos">
                    <input class="input" required type="text" name="tlf_repre" id="tlf_repre" placeholder=" " autocomplete="off" maxlength="12" pattern="[0-9]{4,4}-[0-9]{7,7}" title="Formato 0xxx-xxxxxxx">
            ...
            <div class="contenedor_ubicacion">
                ...
                <div class="campos_ubicacion">
                    ...
                    <div class="container_campos" for="sector">
                        <input class="input" required type="text" name="sector_repre" placeholder=" " autocomplete="off" id="sector_repre" maxlength="30">
